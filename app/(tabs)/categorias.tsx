...
import { FiltroSelected } from "@/components/IntervalSelector/FiltroSelected/FiltroSelected"
...
export default function Categories() {
  ...
  const categoriasUtilizadas = dados.categories.filter(cat => cat.nome !== 'renda')
